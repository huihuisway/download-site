    ...
    <div className="card p-4">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-2xl font-bold mt-2 tabular-nums" style={{ color: 'var(--text)' }}>
          ...
          {topFiles.length === 0 ? (
            ...
            <div className="space-y-0.5">
              {topFiles.map((file, i) => (
                <div
                  key={file.id}
                  className="flex items-center gap-3 py-2.5 px-3 transition-colors group"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px]" style={{ color: 'var(--text-muted)' }}>{file.category} · {formatSize(file.file_size)}</p>
                  </div>
            ...
            <div className="space-y-3">
              {categoryStats.map((cat) => (
                ...
                >
                  ...
                  {/* Progress bar */}
                  <div className="mt-2.5 h-1.5 overflow-hidden" style={{ background: 'var(--muted)' }}>
                    <div
                      className="h-full transition-all duration-500"
                      style={{
                        width: `${Math.min(100, (cat.total_downloads / Math.max(1, dashboard.totalDownloads)) * 100)}%`,
